    ...
    <form action={formAction} className="space-y-10 md:space-y-12">
      ...
      <Section label={t.sectionRoast}>
        <RadioField
          ...
          options={ROAST_LEVELS.map((value) => ({
            value,
            label: label(enums.roastLevels, value),
          }))}
